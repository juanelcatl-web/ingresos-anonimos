      ...
      <div className="flex">
        {items.map(item => (
          <button key={item.id} onClick={() => onNavigate(item.id)}
            className={`flex-1 flex flex-col items-center gap-0.5 py-2.5 transition-all ${activePage === item.id ? 'text-brand-green' : 'text-white/35 hover:text-white/60'}`}>
