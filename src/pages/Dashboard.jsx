    ...
    <div className="max-w-2xl mx-auto px-4 py-5 pb-24 sm:pb-8 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          <Select placeholder="País"      value={filters.country}    onChange={v => setFilter('country', v)}    options={COUNTRIES}   />
          <Select placeholder="Profesión" value={filters.profession} onChange={v => setFilter('profession', v)} options={PROFESSIONS} />
          <Select placeholder="Exp."      value={filters.experience} onChange={v => setFilter('experience', v)} options={EXPERIENCE}  />
        </div>
        {activeCount > 0 && (
